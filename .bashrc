...
# set default visual and cli editor to vim
export VISUAL=vim
export EDITOR=vim
...
#Switch caps lock and escape key (DONE via powertoys)
...
# uses os colors scheme
clear && cd && neofetch --source /home/scott/.config/3ds_logo.txt && ls
# --ascii_colors 12 for ds blue
